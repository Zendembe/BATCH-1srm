...
var format_Xblockandauditorium_22 = new ol.format.GeoJSON();
var features_Xblockandauditorium_22 = format_Xblockandauditorium_22.readFeatures(json_Xblockandauditorium_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Xblockandauditorium_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Xblockandauditorium_22.addFeatures(features_Xblockandauditorium_22);
var lyr_Xblockandauditorium_22 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Xblockandauditorium_22, 
                style: style_Xblockandauditorium_22,
                interactive: true,
                title: '<img src="styles/legend/Xblockandauditorium_22.png" /> Xblock and auditorium'
            });
var format_MainMESS_23 = new ol.format.GeoJSON();
var features_MainMESS_23 = format_MainMESS_23.readFeatures(json_MainMESS_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MainMESS_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MainMESS_23.addFeatures(features_MainMESS_23);
var lyr_MainMESS_23 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_MainMESS_23, 
                style: style_MainMESS_23,
                interactive: true,
                title: '<img src="styles/legend/MainMESS_23.png" /> Main MESS'
            });
var format_OldAcademicBlock_24 = new ol.format.GeoJSON();
var features_OldAcademicBlock_24 = format_OldAcademicBlock_24.readFeatures(json_OldAcademicBlock_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_OldAcademicBlock_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_OldAcademicBlock_24.addFeatures(features_OldAcademicBlock_24);
var lyr_OldAcademicBlock_24 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_OldAcademicBlock_24, 
                style: style_OldAcademicBlock_24,
                interactive: true,
                title: '<img src="styles/legend/OldAcademicBlock_24.png" /> Old Academic Block'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_ACnoisyRoom_1.setVisible(true);lyr_Basketballcourt_2.setVisible(true);lyr_BoysHostel_3.setVisible(true);lyr_Building1_4.setVisible(true);lyr_Building2_5.setVisible(true);lyr_Cblock_6.setVisible(true);lyr_Cafe_7.setVisible(true);lyr_Cafeteria_8.setVisible(true);lyr_Container_9.setVisible(true);lyr_Court_10.setVisible(true);lyr_CricketField_11.setVisible(true);lyr_FootballPitch_12.setVisible(true);lyr_Ganga_13.setVisible(true);lyr_Hostel3_14.setVisible(true);lyr_Krishna_15.setVisible(true);lyr_NewAcademicBlock_16.setVisible(true);lyr_ResearchBlock_17.setVisible(true);lyr_SBlock_18.setVisible(true);lyr_SUPERMARKET_19.setVisible(true);lyr_Tennis_20.setVisible(true);lyr_Trees_21.setVisible(true);lyr_Xblockandauditorium_22.setVisible(true);lyr_MainMESS_23.setVisible(true);lyr_OldAcademicBlock_24.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ACnoisyRoom_1,lyr_Basketballcourt_2,lyr_BoysHostel_3,lyr_Building1_4,lyr_Building2_5,lyr_Cblock_6,lyr_Cafe_7,lyr_Cafeteria_8,lyr_Container_9,lyr_Court_10,lyr_CricketField_11,lyr_FootballPitch_12,lyr_Ganga_13,lyr_Hostel3_14,lyr_Krishna_15,lyr_NewAcademicBlock_16,lyr_ResearchBlock_17,lyr_SBlock_18,lyr_SUPERMARKET_19,lyr_Tennis_20,lyr_Trees_21,lyr_Xblockandauditorium_22,lyr_MainMESS_23,lyr_OldAcademicBlock_24];
...
lyr_Xblockandauditorium_22.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_MainMESS_23.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_OldAcademicBlock_24.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_Xblockandauditorium_22.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
lyr_MainMESS_23.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
lyr_OldAcademicBlock_24.set('fieldImages', {'Name': '', 'descriptio': '', 'timestamp': '', 'begin': '', 'end': '', 'altitudeMo': '', 'tessellate': '', 'extrude': '', 'visibility': '', 'drawOrder': '', 'icon': '', });
...
lyr_Xblockandauditorium_22.set('fieldLabels', {'Name': 'header label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_MainMESS_23.set('fieldLabels', {'Name': 'header label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_OldAcademicBlock_24.set('fieldLabels', {'Name': 'header label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_OldAcademicBlock_24.on('precompose', function(evt) {
